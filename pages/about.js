    ...
    <div>
      <article>
        ...
        <p>
          ...
          client-side cache of your data, which is kept up to date as further queries and mutations
        ...
        <p>
          ...
          . Using the HOC pattern we're able to pass down a central store of query result data
          created by Apollo into our React component hierarchy defined inside each page of our Next
          application.
        </p>
        <p>
